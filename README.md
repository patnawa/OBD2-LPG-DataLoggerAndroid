...
โปรแกรมนี้แนวคิดทำขึ้นมาเพื่อง่ายต่อการบันทึก Log จากรถยนต์ที่ใช้แก๊ส LPG และคำนวนค่า LTFT STFT แบบ Real-time โดยเชื่อมต่อกับ AI เพื่อวิเคราะห์ความผิดปรกติของเครื่องยนต์ และสามารถเชื่อมต่อกับ Ai Agent เพื่อวิเคราะห์การจูนแก๊สแบบอัตโนมัติ ของรถที่ไม่มีระบบ OBD โดยคำนึงถึงความแม่นยำในการคำนวณค่าต่างๆของเครื่องยนต์และระบบแก๊ส มีการรองรับการเชื่อมต่อ AI Agent และ Rest API Server (HTTP) เพื่อให้ Ai Agent สามารถดึงข้อมูลจากรถยนต์ได้โดยตรง และส่งค่า Parameter กลับมายังตัวแอปเพื่อบันทึกเป็นตัวกลางในการเชื่อมต่อระหว่างรถยนต์ และ AI.

โปรแกรมยังสามารถ Detect PID id ได้อัตโนมัติ โดยจะค้นหา PID id ที่มีอยู่ในรถยนต์ และสามารถบันทึก Log ได้ตามต้องการ และยังมี O2 Sensor Logging ที่สามารถบันทึกค่า Voltage ของ O2 Sensor ได้ทั้ง 8 ตัว.
