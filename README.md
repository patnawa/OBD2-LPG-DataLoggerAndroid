...
และยังสามารถคำนวนค่า Closed/Open Loop STFT LTFT MAP และ ECT พร้อมกับการเพิ่ม Logic กรองข้อมูล ดึงมาคำนวณเฉพาะที่ตรงตามเงื่อนไข หาค่าความเบี่ยงเบนที่เหมาะสมในการจูนแก๊สได้อัตโนมัติ และมีระบบ Tune Assist ช่วยในการปรับจูนเชื้อเพลิงอย่างแม่นยำ
